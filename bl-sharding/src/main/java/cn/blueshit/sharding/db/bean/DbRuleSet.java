package cn.blueshit.sharding.db.bean;
...
public class DbRuleSet {
    ...
    public void setDbKeyString(String dbKeyString) {
        this.dbKeyString = dbKeyString;
        if (StringUtils.isNotBlank(dbKeyString)) {
            dbKeyArray = Arrays.asList(dbKeyString.trim().split(","));
        }
    }
}
